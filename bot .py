...
# ✅ সব sensitive data environment variable থেকে নেওয়া হচ্ছে
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
GPLINKS_API = os.environ.get("GPLINKS_API", "")
GITHUB_TOKEN = os.environ.get("GITHUB_TOKEN", "")
GITHUB_REPO = os.environ.get("GITHUB_REPO", "bdtoolxmedia/bdtoolxpost_bot")
...
def save_posts(posts, sha):
    ...
    # sha "new" মানে ফাইল নেই, নতুন তৈরি হবে
    if sha and sha != "new":
        payload["sha"] = sha
...
def process_message(message):
    ...
    posts.insert(0, post)
    posts = posts[:100]  # সর্বোচ্চ ১০০ পোস্ট রাখো
...
# ✅ Netlify Python functions এর সঠিক handler format
def handler(event, context):
    ...
    if method == "GET":
        ...
        return {
            "statusCode": 200,
            "body": json.dumps({"message": "BD ToolX Bot চলছে! Webhook সেট করতে /?set=1 ভিজিট করুন।"}),
        }
